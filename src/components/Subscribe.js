...
const Subscribe = () => {
    ...
    const handleChange = (e) => {
        ...
        const isValid = /^[A-Za-z0-9]([-_.]?[A-Za-z0-9])*@[A-Za-z0-9]([-_.]?[A-Za-z0-9])*\.kr$/.test(inputEmail) || /^[A-Za-z0-9]([-_.]?[A-Za-z0-9])*@[A-Za-z0-9]([-_.]?[A-Za-z0-9])*\.co\.kr$/.test(inputEmail) || /^[A-Za-z0-9]([-_.]?[A-Za-z0-9])*@[A-Za-z0-9]([-_.]?[A-Za-z0-9])*\.[A-Za-z]{3}$/.test(inputEmail);
        setEmail(inputEmail);
